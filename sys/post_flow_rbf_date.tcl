...
#   output_files/rmSeibuCupSoccer.rbf -> output_files/rmSeibuCupSoccer_yyyymmdd.rbf
...
# il rmSeibuCupSoccer.rbf base (quello resta per l'upload MiSTer).

set out_dir "output_files"
set base    "rmSeibuCupSoccer"
